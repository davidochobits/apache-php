...
1. Configurar la clave SSH en `/root/.ssh/id_rsa`.
2. Añadir el host del repositorio a `known_hosts`.
3. Clonar el código fuente en `/var/www/html` si el directorio está vacío.
